...
local MainAPI_URL  = _vX4("68 74 74 70 73 3a 2f 2f 72 61 77 2e 67 69 74 68 75 62 75 73 65 72 63 6f 6e 74 65 6e 74 2e 63 6f 6d 2f 72 65 61 6c 6b 69 64 68 75 62 2f 72 65 61 6c 6b 69 64 2f 72 65 66 73 2f 68 65 61 64 73 2f 6d 61 69 6e 2f 6d 61 69 6e 2e 6c 75 61")
local Backup_URL   = _vX4("68 74 74 70 73 3a 2f 2f 66 75 6e 6c 69 6e 6b 2e 69 6f 2f 50 75 5f 73 32 77 63")
local Core_GuiName = _vX4("45 63 6c 69 70 73 65 53 6c 65 65 6b 55 49 5f 76 33")
...
---------------------------------------------------------
-- HÀM KÍCH HOẠT SCRIPT CHÍNH (REALKIDHUB RUNNER)
---------------------------------------------------------
