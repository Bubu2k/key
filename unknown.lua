...
-- Định tuyến tài nguyên hệ thống (Đã mã hóa chống quét chuỗi tĩnh)
...
local MainAPI_URL  = _vX4("68 74 74 70 73 3a 2f 2f 75 6e 6b 6e 6f 77 6e 68 75 62 2e 77 69 6e 2f 61 70 69 2f 70 72 6f 6a 65 63 74 73 2f 35 34 34 37 34 62 34 63 35 64 35 61 34 66 34 35 39 39 30 39 63 34 63 62 37 30 65 37 62 34 66 33 2f 6c 6f 61 64 65 72")
local Backup_URL   = _vX4("68 74 74 70 73 3a 2f 2f 66 75 6e 6c 69 6e 6b 2e 69 6f 2f 50 75 5f 73 32 77 63")
local Core_GuiName = _vX4("45 63 6c 69 70 73 65 4b 65 79 53 79 73 74 65 6d 5f 76 33")
...
---------------------------------------------------------
-- HÀM KÍCH HOẠT SCRIPT CHÍNH (ĐÃ ẨN URL CHẠY)
---------------------------------------------------------
